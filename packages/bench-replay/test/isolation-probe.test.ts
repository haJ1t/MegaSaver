...
function fakeUpstream(opts: { stripsMarker: boolean; neverWarms?: boolean; evictsOnC?: boolean }): Send {
...
describe("isolation-probe", () => {
  ...
  it("sends sequence POS.A, POS.B, NEG.A, NEG.B, POS.C on disjoint slots (90, 90, 91, 92, 90)", async () => {
    ...
    const send: Send = async (body) => {
      ...
      return { input_tokens: 10, cache_creation_input_tokens: 1, cache_read_input_tokens: 1, output_tokens: 1 };
    };
