...
- db91dd3: Add `mega session disclosure` — reconcile end-of-turn narrative against the observed git delta; per-session receipts, --json report.
...
- 37bf55f: `mega brain sync` — E2E-encrypted sync of the portable project brain through
