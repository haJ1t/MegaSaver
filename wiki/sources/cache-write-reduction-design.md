...
PreToolUse output-route adviser. It corrects the retracted cache-mutation
theory and treats total cost plus task parity—not a cache-write percentage—as
the acceptance metric. (source: `docs/superpowers/specs/2026-08-01-cache-write-reduction-design.md`)
